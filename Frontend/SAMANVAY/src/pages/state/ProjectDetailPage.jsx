  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="outline" size="icon" onClick={() => navigate('/state/projects')}><ArrowLeft className="h-4 w-4" /></Button>
        <div>
      ...
      <Card>
        <CardHeader><CardTitle>Project Overview from MoSJE</CardTitle></CardHeader>
        ...
        <CardContent>
          {!project.assignments || project.assignments.length === 0 ? (
            <div className="text-center p-6 bg-muted/50 rounded-lg">
              ...
              <p className="text-muted-foreground mb-4">The next step is to complete the assignment details.</p>
              <Button onClick={() => setIsAssignFormOpen(true)}>Assign Project</Button>
            </div>
          ) : (
            <div className="space-y-6">
                  ...
                  <div className="p-4 border rounded-lg">
                    <div className="flex justify-between items-start">
                        ...
                        <div>
                            ...
                            <p className="font-semibold text-lg text-right">₹{(assignment.allocatedFunds || 0).toLocaleString()} Lakhs</p>
                        </div>
                    </div>
                    <Separator className="my-4" />
                    <div>
                        <Label className="text-xs text-muted-foreground">Assigned Milestones</Label>
